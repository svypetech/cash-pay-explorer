...
const RegisterPage = () => {
  ...
  Your Finance Partner is Coming Soon
      ...
      <p className="font-poppins font-normal text-[18px] leading-[27px] tracking-normal text-center text-white mt-4 px-3 ">
        ...
        Seamlessly send, receive, deposit, withdraw, and trade crypto with ease. Convert crypto to fiat,
        make international transactions, and enjoy secure P2P trading—all in one place. Even shop effortlessly with
        your CashPay credit card. Register now for the Beta Release!
      </p>

      {register ? <EmailField /> : <Button 
      // onSubmit={() => setRegister(true)} 
      />}
