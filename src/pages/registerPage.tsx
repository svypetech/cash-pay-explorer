...
const RegisterPage = () => {
  ...
  return (
    ...
    {/* <div className="w-screen min-h-screen md:min-h-5/6 bg-[url('/background.svg')] bg-no-repeat bg-top bg-cover flex flex-col items-center justify-end px-2 sm:px-20 pb-10"> */}
      <Image src="/images/logo.svg" alt="logo" width={695} height={157} unoptimized className="w-auto h-auto max-w-full"  />
      ...
      {/* Description */}
      <p className="font-poppins font-normal text-[13px] sm:text-[18px] leading-[27px] tracking-normal text-center text-white mt-4 w-320">
